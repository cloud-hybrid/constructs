...
const Spawn = async (command: string, directory: string = Process.cwd(), stdout: boolean = false, silent: boolean = false): Promise<Stream> => {
    ...
    const Awaitable = new Promise<Stream>( (resolve, reject) => {
